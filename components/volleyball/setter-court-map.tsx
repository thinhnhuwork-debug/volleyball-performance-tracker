...
export function SetterCourtMap({ data }: { data: CourtZoneStat[] }) {
  ...
  return <div className="vnl-analysis">
    <div className="vnl-scorebar"><div><span>HVC</span><b>25</b></div><strong>SET 4 · PHÂN TÍCH CHUYỀN 2</strong><div><b>20</b><span>THU</span></div></div>
    <div className="vnl-court-wrap">
      <div className="vnl-court" role="img" aria-label="Mô hình nửa sân bóng chuyền của HVC, lưới ở mép trên, hàng trước phía trên vạch ba mét và hàng sau phía dưới">
        ...
        <div className="setter-origin"><span>17</span><b>THỊNH</b><small>CHUYỀN 2 / SETTER</small></div>
